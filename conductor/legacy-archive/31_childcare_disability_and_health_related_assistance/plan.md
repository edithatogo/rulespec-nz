...
- [x] Confirm the official source family and legal scope for this track.
...
- [x] Compare current outputs against the relevant backlog family.
- [x] Identify missing eligibility, means-test, rate, and payment surfaces.
- [x] Create or link the upstream tracking issue.

## Phase 2: Source Inventory

- [x] Locate the official legislation, regulations, and agency guidance for this family.
- [x] Record corpus citation paths or source manifests.

## Phase 3: RuleSpec Encoding

- [x] Fill the family-specific surface gaps.
- [x] Keep unrelated legal families separate.
- [x] Add source-linked companion tests.
...
- [x] Implementation slice already present in the `nz/` tree.
- [x] Track ready to archive after conductor bookkeeping.
